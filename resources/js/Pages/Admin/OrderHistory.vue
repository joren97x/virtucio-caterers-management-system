...
<template>
    ...
    <div class="p-4 bg-gray-100 min-h-screen">
        <div class="max-w-7xl mx-auto">
            <!-- Page Title -->
            <h1 class="text-2xl font-bold text-gray-700 mb-6">Order History</h1>
                        ...
                        <tr v-for="(order, index) in orders" :key="order.id"
                            ...
                            <td class="py-3 px-6 text-center">
                                <span :class="{
                                    ...
                                    {{ STATUS_LABELS[order.status] || 'Uknown Status' }}
                                </span>
                            </td>
                            <!-- Actions -->
                            <td class="py-3 px-6 text-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
      ...
      <div class="col-span-3 space-y-6">
        <section aria-labelledby="order-information" class="space-y-4">
          <h3 id="order-information" class="text-lg font-semibold text-gray-700">Order Information</h3>
          <p class="text-sm">
      ...
      <div class="col-span-2 space-y-6">
        ...
        <section aria-labelledby="add-ons">
          ...
          <ul class="list-none mt-2 space-y-2">
            <li v-for="add_on in selectedOrder.add_ons" :key="add_on.id" class="flex justify-between items-center text-sm">
        ...
        <section aria-labelledby="pax-details" v-if="selectedOrder.event_type == 'wedding'">
          ...
          <ul class="list-none mt-2 space-y-2">
            <li class="flex justify-between items-center text-sm">
              ...
              <span class="text-gray-600">{{ formatCurrency(selectedOrder.service_charge) }}</span>
            </li>
          </ul>
        </section>
        ...
        <section aria-labelledby="order-summary" class="pt-4 border-t border-gray-200">
          ...
          <p class="text-sm">
            ...
            <li class="flex justify-between items-center text-sm">
              ...
              <span class="text-gray-600">{{ formatCurrency(selectedOrder.remaining_balance) }}</span>
            </li>
          </p>
