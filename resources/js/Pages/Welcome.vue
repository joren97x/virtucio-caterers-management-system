  ...
  <header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <Link :href="route('user.products.index')" class="text-sm font-semibold leading-6 text-gray-900">Home</Link>
        <Link :href="route('user.products.index')" class="text-sm font-semibold leading-6 text-gray-900">Foods</Link>
        <Link href="/about-us" class="text-sm font-semibold leading-6 text-gray-900">About Us</Link>
      </div>
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <Link :href="route('register')" class="text-sm font-semibold leading-6 text-gray-900 pr-5"> Register <span aria-hidden="true"></span></Link>
  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        <h1 class="text-balance text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Virtucio Caterers</h1>
        <p class="mt-6 text-lg leading-8 text-gray-600">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <Link :href="route('order.pax')" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</Link>
