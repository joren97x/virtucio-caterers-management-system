    ...
    <section class="py-16 max-w-screen-xl mx-auto text-center px-2 xs:px-2 sm:px-2 md:px-6 lg:px-6 xl:px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-white rounded-lg shadow p-2 md:p-6 lg:p-6 xl:p-6">
                <img src="images/image5.jpg" style="height: 300px; object-fit: cover; width: 100%;" alt="Quality"
                    class="mx-auto mb-4">
            ...
            <div class="bg-white rounded-lg shadow p-2 md:p-6 lg:p-6 xl:p-6">
                <img src="images/image4.jpg" style="height: 300px; object-fit: cover; width: 100%;"
                    alt="Customizable Menus" class="mx-auto mb-4">
            ...
            <div class="bg-white rounded-lg shadow p-2 md:p-6 lg:p-6 xl:p-6">
                <img src="images/image3.jpg" style="height: 300px; object-fit: cover; width: 100%;"
                    alt="Professional Service" class="mx-auto mb-4">
    ...
    <section class="bg-gray-100 py-16 px-2 xs:px-2 sm:px-2 md:px-6 lg:px-6 xl:px-6">
        <div class="max-w-screen-xl mx-auto text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                <div class="bg-white rounded-lg shadow p-2 md:p-6 lg:p-6 xl:p-6">
                    <img src="images/catering.jpg" style="height: 300px; width: 100%; object-fit: cover;"
                        alt="Wedding Catering" class="mx-auto mb-4">
                ...
                <div class="bg-white rounded-lg shadow p-2 md:p-6 lg:p-6 xl:p-6">
                    <img src="images/corporate.jpg" style="height: 300px; width: 100%; object-fit: cover;"
                        alt="Corporate Events" class="mx-auto mb-4">
                ...
                <div class="bg-white rounded-lg shadow p-2 md:p-6 lg:p-6 xl:p-6">
                    <img src="images/birthday.jpg" style="height: 300px; width: 100%; object-fit: cover;"
                        alt="Private Parties" class="mx-auto mb-4">
                ...
                <div class="bg-white rounded-lg shadow p-2 md:p-6 lg:p-6 xl:p-6">
                    <img src="images/birthday2.jpg" style="height: 300px; width: 100%; object-fit: cover;"
                        alt="Custom Events" class="mx-auto mb-4">
    ...
    <section class="py-16 max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div class="text-center">
                <div
                    class="bg-indigo-500 text-white w-16 h-16 flex items-center justify-center mx-auto rounded-full mb-4">
