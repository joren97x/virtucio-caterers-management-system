...
const appetizers = [
  {
    id: 1,
    name: 'Fried Calamari',
    description: 'Crispy fried calamari served with a side of marinara sauce.',
    price: '$8.99',
  ...
  },
  {
    id: 2,
    name: 'Garlic Bread',
    description: 'Freshly baked garlic bread with a hint of parsley.',
    price: '$5.49',
    image: 'https://www.thecookierookie.com/wp-content/uploads/2023/04/featured-stovetop-burgers-recipe.jpg',
  },
  {
    ...
    description: 'Creamy dip served with crispy tortilla chips.',
    price: '$7.99',
    image: 'https://www.thecookierookie.com/wp-content/uploads/2023/04/featured-stovetop-burgers-recipe.jpg',
  },
  {
...
<template>
    ...
    <div>
      ...
      >
      <img :src="photoPreview || defaultPhoto" class="w-full h-full">
