...
<template>
    ...
    <div class="p-4 bg-gray-100 min-h-screen">
        <div class="max-w-7xl mx-auto">
            <!-- Page Title -->
            <h1 class="text-2xl font-bold text-gray-700 mb-6">Pending Orders</h1>
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        <tr v-for="(order, index) in orders" :key="order.id"
                            ...
                            <td class="py-3 px-6 text-center">
                                ...
                                <button @click="markAsPaid(order.id)" v-if="order.status != 'pending'"
                            ...
                            <td colspan="6" class="text-center">
                                <div class="p-2">
                                    <div class="justify-center flex items-center ">
                                        <img src="/empty_orders.png" class="mr-6" height="100px" width="100px"
                                            alt="">There are no orders
                                    </div>
                                </div>
                            </td>
                        </tr>
